...
import org.example.client.dto.oauth2.OAuth2CheckTokenRespDTO;
...
public class OAuth2Client {
	...
	private static final String BASE_URI = "http://127.0.0.1:48080/admin-api/system/oauth2";
	...
	private static final String CLIENT_ID = "sso-demo";
...
//		body.add("scope", "");  // 选填，填了会校验
	...
	private static void addClientHead(HttpHeaders headers) {
